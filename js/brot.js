...
xtnd(BrotCtrl.prototype, {
	Z:function(){ return parseInt(this.elems.z.value) },
	X:function(){ return parseFloat(this.elems.x.value) },
	Y:function(){ return parseFloat(this.elems.y.value) },
	I:function(){ return parseInt(this.elems.i.value) },
	T:function(){ return parseInt(this.elems.t.value) },
	...
	setEvents:function(){
		...
		win.addEventListener('keydown',function(e){
			if (e.ctrlKey) {
				switch (e.keyCode) {
					case Key.UP:    ctrl.elems.z.value = ctrl.Z() + parseFloat(ctrl.elems.z.step); break;
					case Key.DOWN:  ctrl.elems.z.value = ctrl.Z() - parseFloat(ctrl.elems.z.step); break;
					case Key.LEFT:  ctrl.elems.i.value = ctrl.I() - parseFloat(ctrl.elems.i.step); break;
					case Key.RIGHT: ctrl.elems.i.value = ctrl.I() + parseFloat(ctrl.elems.i.step); break;
				}
			} else {
				switch (e.keyCode) {
					case Key.UP:    ctrl.elems.y.value = ctrl.Y() + parseFloat(ctrl.elems.y.step); break;
					case Key.DOWN:  ctrl.elems.y.value = ctrl.Y() - parseFloat(ctrl.elems.y.step); break;
					case Key.LEFT:  ctrl.elems.x.value = ctrl.X() + parseFloat(ctrl.elems.x.step); break;
					case Key.RIGHT: ctrl.elems.x.value = ctrl.X() - parseFloat(ctrl.elems.x.step); break;
				}
			}
